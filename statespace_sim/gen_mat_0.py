...
def coriolis_matrix(theta1, theta2, dtheta1, dtheta2):
...
def state_space_matrix(theta1, theta2, dtheta1, dtheta2, tau1, tau2):
    """ Compute the state space matrices A and B. """
    # Compute mass, Coriolis, and gravity terms
    M = mass_matrix(theta1, theta2)
    C = coriolis_matrix(theta1, theta2, dtheta1, dtheta2)
