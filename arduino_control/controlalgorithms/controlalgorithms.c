...
class MotorController_c {
    ...
    void SetupPIDController(double kp, double ki, double kd, double w_c, double d_t){
        ...
        //filter.setCutoffTimeConstant(T_c, delta_T); //commented out
    }
    ...
    double pid_controller(int encoder_count){
        ...
        Serial.print("raw output "); Serial.print(raw_output); Serial.println();
        Serial.print("filtered output "); Serial.print(filtered_output); Serial.println();
        Serial.print("U u_amplitude "); Serial.print(scaled); Serial.println();
        //Serial.print("theta_dot_des "); Serial.print(filtered_output); Serial.println();
        //Serial.print("kp "); Serial.print(KP); Serial.println();
        //Serial.print("kd "); Serial.print(KD); Serial.println();
        //Serial.print("ki "); Serial.print(KI); Serial.println();
