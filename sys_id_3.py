...
save_dir = '/home/sez26/Uni2024/MVNLC/Uni2024_MVNLC/reference_signals/corner_stretch_ref/sq/'
...
# # [th_1, th_2] = ref_gen.get_thetas(xy_base[:, 0], xy_base[:, 1], L1, L2)
# [th1_new, th2_new] = ref_gen.get_thetas(xy[:, 0], xy[:, 1], L1, L2)
...
# # ref_sig_plot.ref_plot([reference, ref_cs], ["base","s_curve"])
